...
Public Class CR_Requerimiento
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Almacen_Compras.CR_Requerimiento.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_Requerimiento
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_Requerimiento = New CR_Requerimiento()
        rpt.Site = Me.Site
        Return rpt
    End Function
