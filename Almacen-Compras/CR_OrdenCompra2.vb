...
Public Class CR_OrdenCompra2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Almacen_Compras.CR_OrdenCompra2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCR_OrdenCompra2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CR_OrdenCompra2 = New CR_OrdenCompra2()
        rpt.Site = Me.Site
        Return rpt
    End Function
