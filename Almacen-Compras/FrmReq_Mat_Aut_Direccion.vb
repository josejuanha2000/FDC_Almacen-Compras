...
Public Class FrmReq_Mat_Aut_Direccion
    ...
    Private Sub FrmReq_Mat_Aut_Direccion_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TBDepto.Text = FrmAutorizacionDireccion.TBDepto.Text
